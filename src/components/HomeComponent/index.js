...
class Home extends React.Component {
    ...
    enterPressed = (e) => {
        if (e.key === "Enter") {
            ...
            this.setState({
                tweets: this.state.tweets.filter(item=>item.content.includes(this.state.searchContent))
            })
        }
    ...
    render(){
        ...
        return(
            <div className="w-50 mt-3">
                <SearchBar enterPressed={this.enterPressed} onChangeSearchInput={this.onChangeSearchInput} searchContent={this.searchContent}/>
